...
Child Sexual Abuse (CSA) and Child Sexual Exploitation Material (CSEM)
offenses impose severe harm on survivors and society. While tertiary
prevention for convicted offenders is well-researched in-person,
evidence for secondary prevention --- targeting individuals at risk but
not yet convicted --- is limited, with few high-quality studies.
CSEM-specific programs remain particularly under-evaluated, suffering
from small samples, short follow-ups, and reliance on self-reported
outcomes. A growing number of CSEM offenders and limited access to
outpatient treatment have created a post-release care gap. Web-based
interventions (WBIs) may improve accessibility, yet empirical evidence
for indivudals who have committed CSA or CSEM offenses remains scarce.
Only one study evaluated a guided WBI (Prevent It), showing a small
effect on CSEM viewing, but with low conviction rates in the sample. To
date, no WBI has been tested for indivudals who have committed CSA or
CSEM. This study evaluates a new guided WBI, testing its effectiveness
in reducing dynamic risk factors a randomized controlled trial compared
to a psychological placebo.

\subsection*{Methods}\label{methods}

This prospective, parallel-group, placebo-controlled RCT was conducted
online in Germany with 1:1 randomization. Eligible participants were
individuals under community supervision for CSA (§176ff StGB) or CSEM
(§184b StGB), aged ≥18, with ≥6 months probation and online access.
Exclusions included severe psychiatric or cognitive impairments.
Randomization was stratified by offense type, supervision type, and
static risk, using a block design (block size 4). Participants, outcome
assessors, and analysts were blinded. The digital intervention,
comprised six guided cognitive-behavioral modules targeting dynamic risk
factors; the placebo arm delivered non-specific psychoeducation on
healthy living. Primary outcome was the CARES (Child Sexual Abuse Risk
Evaluation Self-Report), a self report scale. Secondary outcomes
included module-specific questionnaires on meaningful risk factors.
Analysis followed intention-to-treat principles. Primary analysis used
MMRM with treatment group, time (six assessments), treatment-by-time
interaction, baseline CARES, and stratification factors as fixed effects
under the assumption of an unstructured covariance. Multiple
reference-based imputations were used for sensitivity analysis.
Secondary outcomes were analyzed using non-parametric Brunner-Munzel
tests with Bonferroni-Holm correction. All tests were two-sided at α =
0.05. The trial was prospectively registered on April 24, 2020 in the
German Clinical Trial Register (DRKS00021256).

\subsection*{Findings}\label{findings}

Of 385 screened individuals, 369 were randomized (182 placebo, 187
intervention); 213 included in ITT analysis. The MMRM for the primary
outcome showed no significant treatment effects over time (all p≥0·15).
Within-arm analyses revealed significant reductions in self-reported
risk factors at module one (intervention: p = 0·005) and module three
(p\textless0·01) in both trial arms. Only one secondary outcome reached
significance after correction for multiple comparisons: self-reported
child sexual interest decreased (ESIQ, p=0·001) in the intervention arm.
There were no significant differences in re-offense rates as reported by
community supervisor or adverse events. The intervention arm required
longer to complete modules, with higher working time in modules one,
four, and five (all p ≤ 0·046). As a side effect, therapeutic alliance
(WAI-SR) improved significantly in the intervention arm (p ≤ 0·006). No
serious safety concerns were reported.

\subsection*{Interpretations}\label{interpretations}

This RCT found no significant superiority of the WBI \citet{myTabu} over
placebo in reducing dynamic risk factors among ICCO, despite a
unexpected small reduction in sexual interest in children. Robust
improvements in therapeutic alliance with supervision officers suggest
potential benefits. The null result aligns with recent meta-analyses
showing smaller effects in high-quality studies. Differences in sample
characteristics and treatment intensity may explain the lack of
efficacy. High dropout, prolonged module completion, and low baseline
risk may have attenuated detectable effects. While the CARES is a
promising new measure, its link to official recidivism remains
unverified. The study represents the largest RCT to date on WBIs for
ICCO, but implementation is not justified without re-working the WBI.
The results suggest future work needs to focus on improving engagement
...
Before undertaking this study, no published data on the efficacy of
web-based interventions (WBI) in reducing risk-factors of individuals
who committed CSA or CSEM offences was available. The results of the
literature search have been published online 2021. A placebo-controlled
RCT of a WBI exclusively for CSEM users been reported for the first time
in 2022. The RCT demonstrated a small, but significant reduction of time
spended on viewing CSEM based on self-reports (Cohen's d 0·18). The RCT
involved 160 individuals with CSEM use but only 6.9\% had prior
convictions, limiting generalizability to individuals who committed CSA
or CSEM offences. In 2024, an updated review revealed no further
empirical evidence. A systematic search was conducted in PubMed,
PsycINFO, Scopus, and Web of Science from January 2024 to March 2025
using the terms (``web-based intervention'' OR ``digital intervention'')
AND (``child sexual abuse'' OR ``child sexual exploitation material'' OR
``pedophilia'') AND (``recidivism'' OR ``re offense'' OR ``risk
factor'') AND (``randomized controlled trial''). Results indicate, to
the best of our knowledge, that no data on effectiveness of WBIs for
individuals who committed CSA or CSEM offences is published yet.
...
The study is the first randomized controlled trial to evaluate a WBI
specifically designed for individuals who have committed CSA or CSEM
offences. It addresses a critical gap in the literature by assessing the
effectiveness of a WBI in reducing dynamic risk factors among a
population, which has not been previously evaluated. Unlike prior
studies focusing on secondary prevention with minimal conviction
history, this trial targets ICCO with a structured, modular WBI based on
empirical meaningful risk-factors. This RCT provides first preliminary
evidence on the impact of a WBI for individuals who have committed CSA
or CSEM offences.
...
The current evidence base indicates that tertiary in-person treatment
programs reduce recidivism in individuals who have committed CSA
offenses, the empirical evidence for individuals with CSEM offences is
not as well studied. Besides this encouriging results, for individuals
who have committed CSA or CSEM offences, access remains limited during
community supervision. WBIs offer a promising avenue to bridge the
post-release care gap. While preliminary evidence exists for WBIs in
secondary prevention, this study adds preliminary support for
individuals who have committed CSA or CSEM offences. Future research
must evaluate official re-offense data, and needs to focus on improving
...
\citep{piolantiGlobalPrevalenceSexual2025} Beyond its profound short-
and long-term consequences for survivors, CSA represents a substantial
challenge for society due to high economical costs
\citep{kewleyPreventingChildSexual2023}. These figures clearly
demonstrate the importance of preventing CSA and CSEM.

In prevention, a distinction is commonly drawn between primary,
secondary, and tertiary prevention programs. Primary initiatives are
directed at children and their parents, whereas secondary prevention
seek to engage adults identified as being at risk for CSA or CSEM, but
have not yet been convicted. Tertiary programs have the longest history
and are designed for Individuals who already committed CSA or CSEM
Offenses (ICCO). \citep{kewleyPreventingChildSexual2023} In recent
years, more and more secondary prevention programs for ICCO have been
implemented. \citep{setoEvaluatingChildSexual2024} However, a recent
meta-analysis identified only five publications exploring the
effectiveness of secondary prevention for ICCO, none of them with a
...
programs for ICCO has been studied extensively. In a recent meta-meta
analysis, including 21 meta-analyses on tertiary treatment programs, a
overall treatment effect with an odds ratio (OR) of 0·67 was reported.
\citep{olverSexualOffenseTreatment2025} Several moderators have been
identified: community treatment programs provide higher effect-sizes
than institutional programs, individualized programs show higher
effect-sizes than group programs, high-intensity programs are more
effective than low-intensity programs, and the higher the methodological
quality, the lower the effect size.
...
the effectiveness of secondary prevention programs, but also shed light
on the methodological weakness of existing studies on the effectiveness
of prevention programs for individuals who have used CSEM: mostly, they
...
\citep{gouveiaSystematicReviewEffectiveness2025} Thus, for individuals
who have been sentenced for CSEM as well as for secondary prevention
...
of Supervision Officers (SOs) and Study Therapists (STs) was not
...
\caption{\label{tbl-module-content}Content of the trial arms.}
...
\toprule
Module & Intervention & Placebo \\ 
\midrule\addlinespace[2.5pt]
\textbf{Module 1} & \textbf{Motivation}

\begin{itemize}
\item Exercises on identifying personal values and future aspirations in order to enhance treatment readiness and reduce resistance to change.

\item Psychoeducation on improving decision-making by weighting long-term consequences over immediate rewards.

\item Based on structured goal-setting techniques, participants transform abstract desires into specific, measurable, and achievable objectives, increasing self-efficacy and clarity about their own needs and personal values in order to enhane treatment readiness.

\end{itemize} & \textbf{Physical activity}

\begin{itemize}
\item Psycho-educational content promotes the benefits of physical activity, identifies personal barriers, and set achievable goals to build motivation for physical activity.

\item The importance of motor skills, coordination, and balance, enhancing physical confidence and improving participation in daily and therapeutic activities is highlighted.

\item Through guided exercises, participants are introduced to break sedentary patterns, to increase awareness of health risks and motivated for a sustainable, active living.

\end{itemize} \\ 
\textbf{Module 2} & \textbf{Supervision and social relationships}

\begin{itemize}
\item Development of skills to build trust and collaborative working relationships with supervision officers, reducing resistance against community supervision and improving adherence to supervision mandates.

\item Identification of avoidance patterns that interfere with engagement in community supervision, using cognitive-behavioral strategies to enhance compliance with structured interventions.

\item Through guided exercises, participants examine the impact of adult relationships on emotional regulation and behavioral stability, targeting deficits in capacity for adult intimacy.

\end{itemize} & \textbf{Sports}:

\begin{itemize}
\item Psychoeducation provides the basics of muscle structure and function, increasing self-awareness of physical capabilities and enhancing motivation to engage in structured physical routines.

\item in guided exercises, intrinsic and extrinsic motivators are identified as well as barriers like low confidence or time constraints that affect adherence on personal training plans.

\item By reflecting on personal sport preferences in exercises, participants recognize how peer or cultural influences may shape physical activity choices, reducing susceptibility to negative social pressures.

\end{itemize} \\ 
\textbf{Module 3} & \textbf{Emotion management}:

\begin{itemize}
\item Identification of emotions as indicators of unmet personal needs, reducing impulsive reactions by linking affective states to underlying psychological demands.

\item Through mindfulness exercises and case examples, participants learn the importance of non-reactive awareness of emotions and connected bodily sensations, improving impulse control and reducing maladaptive coping.

\item Differentiation of emotional experiences and action urges using tools like the tension scale, fostering pause-and-reflect strategies to interrupt impulsive behaviors.

\item Creation of a personalized skill set, with adaptive, individualized responses to emotional distress, enhancing long-term emotional regulation and self-management.

\end{itemize} & \textbf{Healthy sleep}:

\begin{itemize}
\item Psychoeducation promotes that sleep quality directly influences emotional regulation, cognitive function, and physical health, addressing impulsivity and emotional dysregulation that undermine sleep hygiene.

\item Understanding sleep cycles and physiological restoration helps link poor sleep to heightened stress, supporting those with external or sexualized coping patterns in developing healthier responses.

\item Practical, non-drug strategies are taught in exercises to manage shift work and jetlag, promoting consistent routines and environmental adjustments that support long-term sleep stability.

\end{itemize} \\ 
\textbf{Module 4} & \textbf{Problem solving}:

\begin{itemize}
\item Psychoeducation on problem-solving deficits as a core component of self-regulation difficulties, understanding that challenges are manageable through structured, cognitive-behavioral approaches.

\item Guided exercises following the 7-Step Problem-Solving Plan to systematically identify, define, and address problems, enhancing decision-making and reducing impulsive or avoidant reactions.

\item Through video examples and case studies, participants practice distinguishing between changeable and unchangeable issues, generating realistic solutions, and evaluating outcomes.

\end{itemize} & \textbf{Dreaming}:

\begin{itemize}
\item Psycho-educational content focus on the neuroscience of dreaming, including REM and non-REM sleep stages.

\item Through exercises like dream journaling, and symbolic interpretation, participants develop reflective practices that enhance awareness of dreams.

\item The module links stress, sleep disruption, and dream content, illustrating how chronic stress undermines executive function and exacerbates difficulties in structured thinking and solution generation.

\item Case studies highlight trauma-related dream patterns, showing how unresolved psychological distress and poor sleep hinder insight and cognitive restoration.

\end{itemize} \\ 
\textbf{Module 5} & \textbf{Offense-supportive attitudes}

\begin{itemize}
\item Need-principle: Identifaction of three offense-supportive cognitions; the participant must choose three out of 16 pre-defined offense-supportive cognitions.

\item Psychoeducation on how offense-supportive cognitions arise from selective attention to partial truths, reinforcing denial and minimizing consequences through psychological defense mechanisms.

\item Through cognitive restructuring, participants challenge distorted beliefs and promoting critical evaluation of harmful thought patterns in guided exercises.

\item Case studies and video examples illustrate real-world consequences of distorted thinking, bridging the gap between perceived justification and actual harm.

\end{itemize} & \textbf{Nutrition}:

\begin{itemize}
\item Adaptive: Psychoeducation provides foundational knowledge on nutrition, digestion; the participant mus choose three out of six nutrition styles.

\item Through guided exercises, participants explore ethical, health, and environmental motivations for three out of 6 different nutrition types (e.g. plant-based diets, fostering empathy and prosocial decision-making).

\item Practical skills in meal planning and grocery shopping build confidence and sustainability, empowering lasting dietary changes that enhance psychological health and reduce behavioral risk.

\end{itemize} \\ 
\textbf{Module 6} & \textbf{Sexuality}

\begin{itemize}
\item Psychoeducation focus on the differentiation between healthy and problematic sexual interests and on how sexual preoccupation can increase reoffending risk.

\item The module addresses emotional congruence with children as a potential risk-factor, emphasizing the importance of maintaining emotional and physical boundaries between oneself and children to reduce relapse potential (relapse prevention).

\item Cognitive restructuring techniques are used to challenge distorted beliefs about sexual behavior, fostering insight and promoting adaptive, non-harmful thought patterns.

\item Through identification of high-risk triggers and personalized coping strategies, the self-regulation, self-efficacy, and control over problematic sexual urges and fantasies will be focused.

\end{itemize} & \textbf{Well-being}:

\begin{itemize}
\item Psychological well-being is distinguished from happiness, focusing on meaning, inner balance, and personal growth, explored through reflections on identity, nature, music, and laughter.

\item Participants challenge the myth of universal well-being, recognizing its subjective nature and the importance of personal values, identity, and life context in shaping health and satisfaction.

\item Through exercises, participants explore the gut-brain axis, mindful eating, and hygiene practices, linking nutrition, self-care, and bodily awareness to mental clarity and psychological stability.
...
\pandocbounded{\includegraphics[keepaspectratio]{resources/diagrams/fig-trial-profile-smaller.png}}
...
Q3\,30, p=0·049, p\textsubscript{adj}=0·59), the CVTRQ increased from
median 85 (Q1\,79 to Q3\,90) to median 87 (Q1\,80 to Q3\,92), indicating
improved treatment readiness (p=0·0060; p\textsubscript{adj}=0·078), and
the DERS increased from median 5 (Q1\,5 to Q3\,6·5) to median 6 (Q1\,5
to Q3\,8, p=0·0050, p\textsubscript{adj}=0·070), indicating detoriation
of emotion regulation. No other secondary endpoint revealed significance
(all p≥0·066; Table~\ref{tbl-sec-pairwise-intervention}). In the placebo
...
observed (all p≥0·12; Table~\ref{tbl-sec-pairwise-placebo}). See
appendix Table 18 for results of xploratory analyses of change from
baseline and appendix Section 7 for results of explorative regression
models.
...
q≥0·17; appendix Table 4). The MMRM for the time working on content
revealed a significant treatment-by-time interaction at module one
(\(\beta\) 360 hours, 95\% CI 49 to 671, p=0·024), module four
(\(\beta\) 236 hours, 95\% CI 19 to 453, p=0·034), and at module five
(\(\beta\) 324 hours, 95\% CI 6.1 to 641, p=0·046). No significance was
observed at module two (\(\beta\) 148 hours, 95\% CI -48 to 345,
p=0·14), module three (\(\beta\) 188 hours, 95\% CI -96 to 473, p=0·19),
and module six (\(\beta\) 93 hours, 95\% CI -142 to 328, p=0·42;
appendix Table 5). Post-hoc pairwise comparisons reveled no differences
...
at any time-point (all p≥0·11; appendix Table 38).
...
Tables\,43-44). See appendix Table 45 for explorative change from
...
timepoint (all p≥0·21). See appendix Table 48 for explorative change
...
interest in children was observerd. In line with our hypothesis,
...
Future research must evaluate official re-offense data, needs to focus
on improving engagement and adherence to digital interventions, and
should include in-person treatment comparators to clarify the relative
effectiveness of the WBI. A stricter RNR‑based individualization, the
integration into blended approaches, and a condensation of the content
may enhance adherence and effectiveness.
